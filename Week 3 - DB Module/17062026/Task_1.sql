...
INSERT INTO student (first_name, last_name, email, date_of_birth, department_id, enrollment_year) VALUES
...
INSERT INTO student(first_name, last_name, email, date_of_birth, department_id, enrollment_year) VALUES
('Giridharan', 'Ramanan', 'giridharan.r.official@gmail.com', '2006-02-08', 1, 2023),
('Deepak', 'N', 'deepak.05.official@gmail.com', '2005-12-08', 4, 2023);
Select Count(*) from student;

update enrollments set grade='B' where student_id = 5 and course_id= 1 and grade='C';
Select Count(*) from enrollments;
